...
<head>
  ...
  <title>MrDry - Forgot Password</title>
        ...
        <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
          <div class="card border border-light-subtle rounded-3 mt-5 shadow">
            <div class="card-body p-3 p-md-4 p-xl-5">
              ...
              <form action="./service/checkSecurityQuestion.php" method="POST">
                <?php if (isset($_GET['error']) && $_GET['error'] == 'notfound'): ?>
                  <div class="error-message text-center mb-3">Username Admin tidak ditemukan</div>
                <?php endif; ?>
