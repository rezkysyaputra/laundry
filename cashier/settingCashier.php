...
include '../includes/db_connect.php'; // pastikan file ini berisi koneksi database
      ...
      <main class="content px-3">
        <div class="container">
          ...
          <div class="container bg-body-secondary">
            <form class="p-3" action="../service/changeProfileCashier.php" method="post">
              ...
              <div class="d-flex justify-content-end">
                ...
                <a href="settingCashier.php" type="menu" class="btn btn-primary">Batal</a>
              </div>
            </form>
          </div>
        </div>
